...
vector_t *vector_new() {
    ...
    /* Check the data attribute of our vector to make sure we got memory */
     if (retval->data == NULL) {
        free(retval);				//Why is this line necessary? // it is necessary to free the reserved space in heap otherwise there will be memory leakage.
       allocation_failed();
     }
...
void vector_set(vector_t *v, size_t loc, int value) {
    /* Wha:t do you need to do if the location is greater than the size we have
